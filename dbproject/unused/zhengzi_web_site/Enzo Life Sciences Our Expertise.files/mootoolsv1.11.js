...
Element.extend({
	...
	*/
	...
	Example:
		...
		<img src="whatever.gif" tppabs="http://svn.mootools.net/tags/1-11/Native/whatever.gif" alt="whatever dude">
		(end)
	*/
...
Element.extend({
	...
	*/
	...
	Example:
		(start code)
		<form id="myForm" action="javascript:if(confirm('http://svn.mootools.net/tags/1-11/Element/submit.php?email=bob@bob.com&zipCode=90210  \n\nThis file was not retrieved by Teleport Ultra, because the server reports that this file cannot be found.  \n\nDo you want to open it from the server?'))window.location='http://svn.mootools.net/tags/1-11/Element/submit.php?email=bob@bob.com&zipCode=90210'" tppabs="http://svn.mootools.net/tags/1-11/Element/submit.php?email=bob@bob.com&zipCode=90210">
...
Element.extend({
	...
	Example:
		(start code)
		<form id="myForm" action="javascript:if(confirm('http://svn.mootools.net/tags/1-11/Remote/submit.php?email=bob@bob.com&zipCode=90210  \n\nThis file was not retrieved by Teleport Ultra, because the server reports that this file cannot be found.  \n\nDo you want to open it from the server?'))window.location='http://svn.mootools.net/tags/1-11/Remote/submit.php?email=bob@bob.com&zipCode=90210'" tppabs="http://svn.mootools.net/tags/1-11/Remote/submit.php?email=bob@bob.com&zipCode=90210">
		<input name="email" value="bob@bob.com">
		<input name="zipCode" value="90210">
		</form>
		<script>
...
Example:
	(start code)
	<img src="../../../images/i.png" tppabs="http://svn.mootools.net/images/i.png" title="The body of the tooltip is stored in the title" class="toolTipImg"/>
	<script>
